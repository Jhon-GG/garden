...
export const getAllClientsWithPaymentsIn2008 = async () => {
    let res = await fetch("http://172.16.101.146:5375/payments");
...
export const getAllPaymentsWithPaypaln2008 = async () => {
    let res = await fetch("http://172.16.101.146:5375/payments?payment=PayPal");
    let data = await res.json();
    let dataUpdate = [];
...
export const getPaymentsOfSalesRepresentatives = async (code) => {
    let res = await fetch(`http://172.16.101.146:5375/payments?code_client=${code}`);
