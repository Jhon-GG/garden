...
export const getClientsWithNameAndLastNameOfTheSalesManager = async () => {
    let res = await fetch("http://172.16.101.146:5371/clients");
...
export const getOfficesInFuenLabrada = async() => {
    let resClients = await fetch("http://172.16.101.146:5371/clients?city=Fuenlabrada");
...
export const getCodeOfClient = async (code) => {
    let res = await fetch(`http://172.16.101.146:5371/clients?client_code=${code}`)
...
export const getClientsWell = async () => {
    let res = await fetch("http://172.16.101.146:5371/clients?code_employee_sales_manager");
