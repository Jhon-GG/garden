...
export const getAllStatusesOfaRequest = async () => {
    let res = await fetch("http://localhost:5378/requests");
...
export const getAllRequestsOutOfTime = async () => {
    let res = await fetch("http://localhost:5378/requests?status=Rechazado");
    let data = await res.json();
    let dataUpdate = [];
...
export const getAllDiferenceOfTwoDays = async () => {
    let res = await fetch("http://localhost:5378/requests?status=Entregado");
    let data = await res.json();
    let dataUpdate = [];
...
export const getAllStatusPayments = async() =>{
    let res = await fetch("http://localhost:5378/requests?status=Pendiente");
    let data = await res.json();
    return data;
}
...
export const getDetailsOfRequest = async (code) => {
    let res = await fetch(`http://localhost:5378/requests?code_request=${code}`)
    let data = await res.json();
    return data
}
...
export const getAllRequests = async (code) => {
    let res = await fetch(`http://localhost:5378/requests?code_client=${code}`);
